...
#levels, channels, num_classes=1,block=BasicBlock, residual_root=False, return_levels=False,pool_size=7, linear_root=False
    model = DLA([1, 1, 1, 2, 2, 1],
                [16, 32, 64, 128, 256, 512],num_classes=5,
